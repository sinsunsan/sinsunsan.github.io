...
Photo de chantier avec vue floue chercher


# Soirée BIM et parametric design III
...
* Comment travailler avec un robot : comment apprendre à un robot d'assembler un mur avec des briques de forme différentes. Nécessité d'utiliser le deeplearning. Il faut l'entrainer avec des centaines de milliers d'images de ce qu'est une brique. Et finit par marcher !
...
Quand on veut innover, il faut aller de l'avant et mettre des défis les autres et notamment les industriels.
...
Le concepteur peut modifier les éléments du catalogue, car il sait qu'il en a la possibilité. 

La conception paramétrique permet de faire des variantes de manière très efficace mais aussi L'automatisation de taches. L'extraction de données. 

Les pièces doivent être tracables comme dans l'industrie, et doit suivre tous le processus de conception jusqu'à la maintenance. 

Grace à des applications smartphone, on peut suivre la vie d'une pièce jusqu'au chantier. 

L'industrie 3.0 avait amené l'industrialisation. L'industrie 4.0 permet d'avoir une personnalisation beaucoup plus simple et accessible de l'extérieur. 

On peut par exemple faire faire un treillis soudé sur mesure qui s'adapte à la surface à couvrir. 

Pour la cité du vin conçu avec XTU, 2231 panneaux. 1 seul a été defectueux. Précision de pose de +-2mm. Possibilité de travailler sur une maquette du chantier obtenu par un scan 3D. 

Autre cas d'étude, l'Arena du pays de nice, 1082 tôle en forme cintrée. Permet de gagner du temps, de la rationaliser et de la qualité. 
...
On rêve d'un continum de l'esquisse jusqu'à la pose. 
...
En 2005, projet de Zaha Hadid de la piscine des JO de Londres
...
On peut travailler avec des inputs en simultanés qui sont la géométrie dessinée par l'architecte, tout en couplant avec les contraintes de matériaux.

Fonctionne par itérations courtes entre l'industriel et l'archiecte, pour trouver une solution au plus près de la volonté de l'architecte.

Pour ce projet, ils ont développés un outil d'optimisation de la géométrie, qui permet de passer d'un dessin avec des surfaces non dévelopables en un dessin avec des surfaces developables.
...
* Qu'elle est la souplesse des architectes par rapport au dessin pour qu'il soit fabricables ?  
...
Les architectes manipulent la NURBS physiquement. Le process de dessin de la coque chez Zaha Hadid était assez halucinant : choix d'une courbe, qui a été étiré, puis découpé en deux, reaxé, et enfin jointoyé à la main par une myriade de dessinateur. Donc un processus de conception qui a l'époque en 2009 était très manuel !
